import { MeshBasicMaterial, TextGeometry, PlaneGeometry, Mesh, Color, MeshLambertMaterial, SpriteMaterial, Sprite, SphereGeometry, Object3D, DoubleSide, Texture, Font, Scene } from "three";
